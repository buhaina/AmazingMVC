...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#"><?php echo $this->getApplication()->getConfiguration()['applicationName']?></a>
        </div>
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                <!-- TODO: handle active: <li class="active"><a href="#">Home</a></li> -->
                <?php
                foreach($this->getApplication()->getConfiguration()['navigationBar'] as $key => $value) {
                    $url = $this->getApplication()->getUrl($value);
